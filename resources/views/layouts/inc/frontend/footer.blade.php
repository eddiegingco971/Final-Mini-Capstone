<div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <p>
                        Thank you for always buying our products! Charoot
                    </p>
                </div>
                <div class="col-md-3">
                    ...
                    <div class="mb-2"><a href="{{ url('/collections/'.$categoryItem->slug) }}" class="text-white">{{$categoryItem->name}}</a></div>
                    @endforeach
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; 2022 - {{ $appSetting->website_name ?? 'website name' }}. All rights reserved.</p>
                </div>
                <div class="col-md-4">
                    <div class="social-media text-white">
                        ...
                        {{-- @if($appSetting->facebook) --}}
                            <a href="{{ $appSetting->facebook ?? 'FB' }}" target="_blank"><i class="fa fa-facebook"></i></a>
                        {{-- @endif
                        @if($appSetting->twitter) --}}
                            <a href="{{ $appSetting->twitter ?? 'TWT' }}" target="_blank"><i class="fa fa-twitter"></i></a>
                        {{-- @endif
                        @if($appSetting->instagram) --}}
                            <a href="{{ $appSetting->instagram ?? 'IG' }}" target="_blank"><i class="fa fa-instagram"></i></a>
                        {{-- @endif
                        @if($appSetting->youtube) --}}
                            <a href="{{ $appSetting->youtube ?? 'YT' }}" target="_blank"><i class="fa fa-youtube"></i></a>
                        {{-- @endif --}}
                    </div>
                </div>
            </div>
